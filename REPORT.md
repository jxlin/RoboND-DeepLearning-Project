...
Even though the same model can be used, there might be some tweaking needed if working with a very different and complex scenario ( apart from the input-output interfaces and using the right dataset ).
